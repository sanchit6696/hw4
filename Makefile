CC = mpicc
FLAGS = -O3 -Wall -g
EXECS = mpi_solved1 mpi_solved2 mpi_solved3 mpi_solved4 mpi_solved5 mpi_solved6 mpi_solved7 jacobi_mpi2D ssort
...
jacobi_mpi2D: jacobi_mpi2D.c
	${CC} ${FLAGS} $^ -o jacobi_mpi2D -lm
